...
export const Route = createFileRoute("/game/rps/friend")({
  validateSearch: (search: Record<string, unknown>): Search => ({
    code: typeof search["code"] === "string" ? search["code"] : undefined,
  }),
  head: () => ({
    meta: [
      { title: "Rock Paper Scissors With a Friend — Private Room" },
      {
        name: "description",
        content: "Create a private Rock Paper Scissors room and duel your friend in realtime.",
      },
      { property: "og:title", content: "Private Rock Paper Scissors Room" },
...
function RpsFriend() {
  ...
  if (!player.id) {
    return (
      <AppShell>
        <PageHeader title="Play With a Friend" back="/game/rps" />
        <GuestGate />
      </AppShell>
    );
  }
